...
export const ERROR_CODES = {
  ...
  PUBLISH_SCOPE_TOO_LARGE: "PUBLISH_SCOPE_TOO_LARGE",
  ...
  AGENT_PARITY_GATE_NOT_PASSED: "AGENT_PARITY_GATE_NOT_PASSED",
  SCHEDULED_AGENT_DISABLED: "SCHEDULED_AGENT_DISABLED",
} as const;
