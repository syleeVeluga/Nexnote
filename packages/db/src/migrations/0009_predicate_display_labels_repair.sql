-- Repair migration: 0008 previously included down-statements in the same file.
-- Recreate the table/idempotent indexes for databases that already recorded 0008.
