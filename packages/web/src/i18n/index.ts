...
i18n
  ...
  .init({
    resources: {
      en: { common: enCommon, auth: enAuth, editor: enEditor, pages: enPages, docs: enDocs, review: enReview, admin: enAdmin, import: enImport },
      ko: { common: koCommon, auth: koAuth, editor: koEditor, pages: koPages, docs: koDocs, review: koReview, admin: koAdmin, import: koImport },
    },
    fallbackLng: "ko",
    defaultNS: "common",
